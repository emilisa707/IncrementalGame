...
public class GameManager : MonoBehaviour
{
    ...
    void Update()
    {
        _collectSecond += Time.unscaledTime;
    ...
    private void CollectPerSecond()
    {
        ...
        AutoCollectInfo.text = $"Auto Collect: {output.ToString("F1")}/ second"; // fungsi ToString("F1") adalah membulatkan angka menjadi desimal yang memiliki 1 angka dibelakang koma
